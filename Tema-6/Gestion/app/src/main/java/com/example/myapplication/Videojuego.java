...
public class Videojuego implements Serializable {
    ...
    private String portadaPath;  // NUEVO: Para imágenes capturadas
    ...
    public Videojuego(int id, String nombre, String descripcion, int portadaResId, String portadaPath, boolean jugado, float valoracion, String web, String telefono, String fechaLanzamiento) {
        this.id = id;
        this.nombre = nombre;
    ...
    public Videojuego(String nombre, String descripcion, int portadaResId, String portadaPath, boolean jugado, float valoracion, String web, String telefono, String fechaLanzamiento) {
        this.id = -1;
        this.nombre = nombre;
        this.descripcion = descripcion;
        this.portadaResId = portadaResId;
